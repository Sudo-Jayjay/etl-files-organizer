...
if __name__ == "__main__":
    ...
    csv_to_sql([r"\\mdcofs900011\corpshared$\NetMgt\Managed Care Analytics\Reporting\Data Imports for SQL\DataFeed\landing_ingestion\MMA_ME_PREMIUM_202607_20260628.txt"], "tmp_weekly_plan_index_for_mapping", conn_str)